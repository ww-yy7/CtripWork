    ...
    <View>
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollview}>
          ...
          <View style={styles.titleanduserview}>
            ...
            <View style={styles.userinfo}>
              ...
              <Image source={require('../../../assets/images/avatar.png')} style={{height: 25, width: 25}} />      
            </View>
          </View>

          {/* 位置时间预算行 */}
          <View style={styles.pdpview} >
          <TouchableOpacity style={styles.position} className="flex-row space-x-2 items-start">
              <MapPinIcon size={25} color="#f87171" />
              <View className="flex space-y-2">
                  <Text style={{fontSize: 13}} className="font-bold text-neutral-700">{item.position}</Text>
      ...
      <View style={styles.clcview}>
        ...
        <View style={styles.commentview}>
          <PencilIcon size={13} strokeWidth={1} color="gray" style={{margin:2}}/>
          <TextInput
            placeholder='说点什么...'
        ...
        >
            <HeartIcon size={28} stroke={isFavourite? "red": "black"} strokeWidth={1.5}  color={isFavourite? "red": "white"} />
        </TouchableOpacity>
        ...
        >
            <StarIcon size={28} stroke={isCollect? "orange": "black"} strokeWidth={1.5}  color={isCollect? "orange": "white"} />
        </TouchableOpacity>
